...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    if (isset($_POST['loginID']) && isset($_POST['loginPassword'])) {
        ...
        if ($theModel->movieDoesNotExist($title)) {
            ...
            $filePath = "/Applications/XAMPP/xamppfiles/htdocs/Real/moviePosters/".$title.".png";
            ...
            $theModel->addNewMovie($title, $year, $rating, $director, $mpaaRating, $runTime, $boxOffice, $filePath);
            session_start();
